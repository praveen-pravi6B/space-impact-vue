...
export class Saucer extends Enemy {
    constructor(...args) { super(...args); this.width = 90; this.height = 50; this.maxFrames = 1; this.frameXStart = this.game.isLevelDark ? 6 : 4; this.frameX = this.frameXStart; this.frameY = 2; }
}
...
export class Marble2 extends Enemy {
    constructor(...args) { super(...args); this.width = 50; this.height = 40; this.maxFrames = 1; this.frameXStart = this.game.isLevelDark ? 3 : 1; this.frameX = this.frameXStart; this.frameY = 4; }
}

export class Marble3 extends Enemy {
    constructor(...args) { super(...args); this.width = 50; this.height = 30; this.maxFrames = 1; this.frameXStart = this.game.isLevelDark ? 5 : 3; this.frameX = this.frameXStart; this.frameY = 4; }
}
